...
function Projects({}: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80 relative z-20 flex w-full snap-x snap-mandatory overflow-y-hidden overflow-x-scroll">
